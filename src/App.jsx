...
const FORMATION_SLOTS = [
  ...
  { key: 'CAM', label: 'CAM / 10', match: ['CAM','10'], x: 33, y: 38 },
  { key: 'CM', label: 'CM / 8', match: ['CM','8'], x: 67, y: 38 },
  { key: 'CDM', label: 'CDM / 6', match: ['CDM'], x: 50, y: 52 },
  { key: 'LB', label: 'LB / Left Back', match: ['LB','RB/LB'], side: 'left', x: 12, y: 68 },
  { key: 'CB', label: 'CB', match: ['CB','DEF'], x: 42, y: 72 },
  { key: 'CB2', label: 'CB', match: ['CB','DEF'], x: 58, y: 72 },
